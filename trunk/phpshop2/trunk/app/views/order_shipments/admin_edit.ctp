...
<?php echo $form->create('OrderShipment');?>
	<fieldset>
 		<legend><?php __('Edit OrderShipment for Order: ' . $order_id);?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('OrderShipment.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('OrderShipment.id'))); ?></li>
