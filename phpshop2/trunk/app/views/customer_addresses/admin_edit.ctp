...
<?php echo $form->create('CustomerAddress');?>
	<fieldset>
 		<legend><?php __('Edit CustomerAddress');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('CustomerAddress.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('CustomerAddress.id'))); ?></li>
