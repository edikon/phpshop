...
<tr>
	...
	<th><?php echo $paginator->sort('billing_company');?></th>
	<th><?php echo $paginator->sort('billing_last_name');?></th>
	<th><?php echo $paginator->sort('billing_first_name');?></th>
	<th><?php echo $paginator->sort('billing_phone');?></th>
