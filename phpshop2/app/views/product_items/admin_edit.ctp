...
<?php echo $form->create('ProductItem');?>
	<fieldset>
 		<legend><?php __('Edit ProductItem for: ' . $product['name']);?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('ProductItem.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('ProductItem.id'))); ?></li>
